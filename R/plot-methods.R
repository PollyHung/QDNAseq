...
setMethod("plot", signature(x="QDNAseqSignals", y="missing"),
    ...
    delcol=getOption("QDNAseq::delcol", "#125B9A"),
    losscol=getOption("QDNAseq::losscol", "#9EA1D4"),
    gaincol=getOption("QDNAseq::gaincol", "#FD8A8A"),
    ampcol=getOption("QDNAseq::ampcol", "#FF4E88"),
    pointcol=getOption("QDNAseq::pointcol", "black"),
    segcol=getOption("QDNAseq::segcol", "#B1E9A3"),
